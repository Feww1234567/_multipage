...
///caching
let producthsWithPrice = [];

export function fetchproducths() {
  if (producthsWithPrice.length === 0) {
    producthsWithPrice = producths.map((producths) => {
      delete producths.albumId;
      delete producths.url;
      producths.price = Math.round(Math.random() * 1000) / 100;
      return producths;
    });
  }
  return producthsWithPrice;
}
